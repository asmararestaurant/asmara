...
<html lang="en">
  ...
  <body>
    <div class="navbar" >
	  ...
	  <div class="row-fluid">
		...
		<ul class="nav">
		  ...
		  <li class='<%block name="current_page_events"/>'><a href="events.html">Gallery</a></li>
		...
		<li style="">
		  <a style="padding: 3px 10px 0px 0px; margin:0px;" target="_blank" href="https://www.facebook.com/asmararestaurant"><img src="img/f_logo.png"/></a>
		</li>
		<li style="">
		  <a style="padding: 3px 0px 0px 0px; margin:0px;" target="_blank" href="http://www.yelp.ca/biz/asmara-san-diego"><img src="img/yelp_25.png"/></a>
		</li>
	      </ul>
	      </div>
	    </div>
	...
	<div class="row-fluid">
	  ...
	  <div class="span10">
	    <div class="post-container center-me">
	      <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"><img alt="Creative Commons License" style="border-width:0" src="http://i.creativecommons.org/l/by-sa/4.0/80x15.png" /></a><br /><span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">Asmara Restaurant</span> by <a xmlns:cc="http://creativecommons.org/ns#" href="asmararestaurantsd.com" property="cc:attributionName" rel="cc:attributionURL">asmararestaurantsd.com</a> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">Creative Commons Attribution-ShareAlike 4.0 International License</a>.
	    </div>	   
	  </div>
	</div>
      </div>
